...
@NonFinalValidatedValue("This shared base centralizes strict single-line character restrictions while each domain value supplies its own bounded Traits implementation and any additional allow-list validation.")
public abstract class SingleLineStrictText extends ExposableValidatedWrappedValue<String>
        implements PubliclyExposed<String> {
    protected <T extends Traits> SingleLineStrictText(String raw, T traits) {
        super(raw, traits);
    }
