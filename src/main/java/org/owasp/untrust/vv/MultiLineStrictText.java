...
@NonFinalValidatedValue("This shared base centralizes strict multiline character and line-break restrictions while each domain value supplies its own bounded Traits implementation and additional content validation.")
public abstract class MultiLineStrictText extends ExposableValidatedWrappedValue<String>
        implements PubliclyExposed<String> {
    protected <T extends Traits> MultiLineStrictText(String raw, T traits) {
        super(raw, traits);
    }
