...
@NonFinalValidatedValue("This shared base centralizes multiline normalization and line-break policy while each domain value supplies its own bounded Traits implementation and any additional content validation.")
public abstract class MultiLine extends ExposableValidatedWrappedValue<String>
        implements PubliclyExposed<String> {
    protected <T extends Traits> MultiLine(String raw, T traits) {
        super(raw, traits);
    }
